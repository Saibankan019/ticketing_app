            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <a href="{{ route('admin.payment-types.create') }}"
                   class="cyber-btn px-6 py-3 text-white rounded-lg font-semibold uppercase tracking-wide">
                    <span class="relative z-10">+ Tambah Tipe Pembayaran</span>
                </a>
            </div>
        </div>
                ...
                <table class="table w-full">
                    <thead class="cyber-table-header text-blue-100">
                        <tr>
                            ...
                            <th class="text-xs uppercase tracking-wider w-3/4">Nama Tipe Pembayaran</th>
                    ...
                    <tbody class="text-gray-300">
                        @forelse ($paymentTypes as $index => $paymentType)
                            <tr class="cyber-table-row">
                                ...
                                <td class="font-medium">{{ $paymentType->nama }}</td>
                                <td class="flex gap-2">
                                    <a href="{{ route('admin.payment-types.show', $paymentType->id) }}"
                            ...
                            <tr>
                                <td colspan="3" class="text-center py-12">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="text-sm mt-2">Tambahkan tipe pembayaran pertama Anda</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
    ...
    <dialog id="delete_modal" class="modal">
        <form method="POST" class="modal-box modal-cyber rounded-2xl border-2 border-red-500/30">
            ...
            <div class="mb-6 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
                <p class="text-gray-300 text-sm">Apakah Anda yakin ingin menghapus tipe pembayaran ini?</p>
