                ...
                <form id="eventForm" class="space-y-6" method="post"
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="judul" placeholder="Contoh: Konser Musik Rock"
                            class="input cyber-input w-full" value="{{ $event->judul }}" required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="deskripsi" placeholder="Deskripsi lengkap tentang event..."
                            class="textarea cyber-input h-32 w-full resize-none" required>{{ $event->deskripsi }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control">
                            ...
                            <input type="datetime-local" name="tanggal_waktu" class="input cyber-input w-full"
                    ...
                    <div class="form-control">
                        ...
                        <label class="label">
                            <span class="label-text-alt text-gray-500">Format: JPG, PNG, max 5MB (Kosongkan jika tidak ingin mengubah)</span>
                        </label>
                    </div>
